...
#include "Modem.h"
  ...
  #define VALIDATE_FIRMWARE true
    ...
    #define PIN_GPS_RX 34
      ...
      #define LORA_PA_MODEL    LORA_PA_UNKNOWN
      #define LORA_PA_PWR_EN   34  // WB_IO2 = PIN_3V3_EN (3V3_S FEM power rail)
      #define LORA_PA_CSD      21  // WB_IO3 = SKY66122 CSD+CPS (same as pin_rxen, stays HIGH)
      #define LORA_PA_CPS      21  // Tied to CSD on RAK13302
      #define LORA_PA_CTX      -1  // Driven by SX1262 DIO2 via DIO2_AS_RF_SWITCH (no GPIO)
      const int PA_GC1109_VALUES[PA_GAIN_POINTS]   = {PA_GAIN_VALUES};
      const int PA_KCT8103L_VALUES[PA_GAIN_POINTS] = {PA_GAIN_VALUES};
